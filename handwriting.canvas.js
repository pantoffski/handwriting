(function (window, document) {
  ...
  handwriting.Canvas.prototype.setStrokeCallBack = function (callback) {
  ...
  handwriting.Canvas.prototype.mouseMove = function (e) {
    ...
    if (this.drawing) this.strokeCallback("move");
  };
  ...
  handwriting.Canvas.prototype.getCenter = function () {
    var minX = Number.MAX_SAFE_INTEGER,
      maxX = Number.MIN_SAFE_INTEGER,
      minY = Number.MAX_SAFE_INTEGER,
      maxY = Number.MIN_SAFE_INTEGER;
    this.trace.forEach((line) => {
      line[0].forEach((x) => {
